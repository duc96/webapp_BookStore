...
app.engine('hbs', exphbs({ extname: 'hbs', defaultLayout: 'layout', layoutsDir: __dirname + '/views/layouts/', handlebars: allowInsecurePrototypeAccess(Handlebars) }));
...
let dev_db_url = 'mongodb+srv://tranvanduc22111996:tranvanduc22111996@cluster0.9j7ev.mongodb.net/Cluster0?retryWrites=true&w=majority';
mongoose.connect(
    dev_db_url,{useUnifiedTopology: true, useNewUrlParser: true},
    err => {
        if(err){
